...
This program tests traversal of a LinkedList with 50,000 elements using get(index).
*/

import java.util.LinkedList;

public class Test50000_Get {
    public static void main(String[] args) {
        LinkedList<Integer> list = createLinkedList(50000);

        System.out.println("Testing get(index) traversal with 50,000 elements:");
