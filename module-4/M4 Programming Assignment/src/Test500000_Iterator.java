...
This program tests traversal of a LinkedList with 500,000 elements using an Iterator.
*/

import java.util.LinkedList;
import java.util.Iterator;

public class Test500000_Iterator {
    public static void main(String[] args) {
        LinkedList<Integer> list = createLinkedList(500000);

        System.out.println("Testing Iterator traversal with 500,000 elements:");
